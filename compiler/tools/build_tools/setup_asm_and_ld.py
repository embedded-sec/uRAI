# Original script is from ACES
# https://github.com/embedded-sec/ACES/blob/master/compiler/tools/build_tools/setup_asm_and_ld.py

import os

TEXT_MAGIC_KEY ='<uRAI_TEXT_SECTIONS>'
DATA_MAGIC_KEY ='<uRAI_DATA_SECTIONS>'
