...
public:
  ...
  enum MIFlag {
    ...
    RAIInstr     = 1 << 11,             //[rai-debug] Flag to check if the
                                        // instruction has already
                                        // been instrumented
    RAIExtLibRet     = 1 << 12,         //[rai-debug] Flag to identify funcs
                                        // returning with an SVC
    RAIExtLibCall     = 1 << 13,        //[rai-debug] Flag to identify extlib
                                        // calls at the end of function
  };
