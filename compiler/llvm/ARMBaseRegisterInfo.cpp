...
// [rai-debug]: option to reserve LR
static cl::opt<std::string> URAIReserveLR("urai-reserve-lr",
                                  cl::desc("Option to reserve the use of LR "),
...
getReservedRegs(const MachineFunction &MF) const {
  ...
  //[rai-debug]: reserve LR
  if (URAIReserveLR.compare("-") != 0 ){
